...
ELIOMOPT          := eliomopt
JS_OF_ELIOM       := js_of_eliom -w +A-4-7-9-37-38-39-41-42-44-45-48 -no-check-prims
ELIOMDEP          := eliomdep
...
$(JS_PREFIX).js: $(call objs,$(ELIOM_CLIENT_DIR),cmo,$(CLIENT_FILES)) | $(TEST_PREFIX)$(ELIOMSTATICDIR)
	${JS_OF_ELIOM} -ppx -o $(JS_PREFIX)_tmp.js -jsopt +gen_js_api/ojs_runtime.js $(GENERATE_DEBUG) $(CLIENT_INC) $(DEBUG_JS) \
